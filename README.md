...
| AI / Media           | TensorFlow.js COCO-SSD, MediaPipe EfficientDet, Ollama Vision (선택), WebRTC, Canvas API |
...
Turborepo 기반 모노레포입니다. 단일 앱이 공유 패키지를 참조합니다.
...
- [x] Phase 6 — 온프레미스 전환 (랜딩 페이지 제거, 단일 앱 구조)
