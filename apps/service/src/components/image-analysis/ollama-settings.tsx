      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <label className="relative inline-flex cursor-pointer items-center">
            ...
            />
            <div className="bg-muted peer h-4 w-8 rounded-full transition-colors after:absolute after:left-0.5 after:top-0.5 after:h-3 after:w-3 after:rounded-full after:bg-white after:transition-transform after:content-[''] peer-checked:bg-sky-500 peer-checked:after:translate-x-4" />
          </label>
        </div>
      </CardHeader>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex gap-1.5">
              ...
              <button
                ...
                className="rounded-md bg-sky-500/10 px-2 py-1 text-xs text-sky-400 transition-colors hover:bg-sky-500/20 disabled:opacity-50"
              >
                연결 확인
              </button>
            </div>
